 ...
 */
final class Version20260212132522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, release_date DATETIME DEFAULT NULL, editor_id INT DEFAULT NULL, INDEX IDX_232B318C6995AC4C (editor_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, review TINYINT NOT NULL, comment LONGTEXT NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_794381C6A76ED395 (user_id), INDEX IDX_794381C6E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE wishli_item (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, user_id INT DEFAULT NULL, game_id INT DEFAULT NULL, INDEX IDX_BCBD4723A76ED395 (user_id), INDEX IDX_BCBD4723E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE wishli_item ADD CONSTRAINT FK_BCBD4723A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE wishli_item ADD CONSTRAINT FK_BCBD4723E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wishli_item DROP FOREIGN KEY FK_BCBD4723A76ED395');
        $this->addSql('ALTER TABLE wishli_item DROP FOREIGN KEY FK_BCBD4723E48FD905');
        ...
        $this->addSql('DROP TABLE wishli_item');
